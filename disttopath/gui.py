...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.LogFilePickerCtrl = wx.FilePickerCtrl( self.LogOptionsTab, wx.ID_ANY, u"DistToPath.log", u"Select a file", u"*.log", wx.DefaultPosition, wx.DefaultSize, wx.FLP_USE_TEXTCTRL )
